...
public class OpenedTagListAdapter extends BaseAdapter {
    ...
    public OpenedTagListAdapter(Context context, int layout, ArrayList<ImageUpload> imageList, int[] unopenedTags) {
    ...
    public OpenedTagListAdapter(Context context, int layout, ArrayList<ImageUpload> imageList) {
        this.context = context;
        this.layout = layout;
        this.imageList = imageList;
    }

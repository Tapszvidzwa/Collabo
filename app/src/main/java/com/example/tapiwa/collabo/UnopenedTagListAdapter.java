...
public class UnopenedTagListAdapter extends BaseAdapter {
    ...
    public UnopenedTagListAdapter(Context context, int layout, ArrayList<ImageUpload> imageList, int[] unopenedTags) {
    ...
    public UnopenedTagListAdapter(Context context, int layout, ArrayList<ImageUpload> imageList) {
        this.context = context;
        this.layout = layout;
        this.imageList = imageList;
    }
    ...
    public  View getView(int position, View view, ViewGroup viewGroup) {
        ...
        holder.unreadMessageNotification.setVisibility(View.VISIBLE);

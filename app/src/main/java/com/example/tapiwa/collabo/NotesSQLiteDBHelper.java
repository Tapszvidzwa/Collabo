...
public class NotesSQLiteDBHelper extends SQLiteOpenHelper {
    ...
    public static final String NOTES_COLUMN_PINNED = "pinned";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table personalNotes" +
                        "(id integer primary key, title text,contents text, time text)"
    ...
    public void insertNote (String title, String contents,String time){
    ...
    public String getTimeUpdated(String title) {
    ...
    public boolean updateNote (String title, String contents, String time,String pinned) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("title", title);
        contentValues.put("contents", contents);

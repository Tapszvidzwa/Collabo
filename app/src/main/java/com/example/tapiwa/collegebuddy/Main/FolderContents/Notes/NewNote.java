...
public class NewNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_color = dbHelper.getNoteColor
                (FolderContentsMainActivity.className, noteTitle.getText().toString());
    ...
    public void saveNote() {
        ...
        dbHelper.insertNote(FolderContentsMainActivity.className,
    ...
    private void sendNote() {
        ...
        Intent sendNote = new Intent(NewNote.this, SelectUsersActivity.class);
        sendNote.putExtra("noteTitle", noteTitle.getText().toString());
        sendNote.putExtra("noteContents", noteContents.getText().toString());
        sendNote.putExtra("callingIntent", getString(R.string.newNote_activity));

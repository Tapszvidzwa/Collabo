package com.example.tapiwa.collegebuddy.Main.FolderContents.Images;
...
public class ImagesAdapter extends BaseAdapter {
    ...
    public View getView(int position, final View view, ViewGroup viewGroup) {
        ...
        final NewImage classImage = imageList.get(position);

        Picasso.with(context).load(classImage.getFull_image_uri()).fetch();
        ...
        holder.tag.setText(classImage.getTag());
        holder.time.setText(classImage.getTimeUploaded());

        final ImageView holderr = holder.imageView;


        Picasso.with(context)
                .load(classImage.getThumb_uri())

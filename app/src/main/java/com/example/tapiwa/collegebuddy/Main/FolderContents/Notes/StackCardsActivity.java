...
public class StackCardsActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        mToolbar.setTitle(FolderContentsMainActivity.className + " Notes");
        ...
        stackViewAdapter = new NoteStackViewAdapter(noteCards, R.layout.item_stack_note, StackCardsActivity.this, false);
    ...
    private void initializeListeners() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent openDisplayNote = new Intent(StackCardsActivity.this, DisplayNoteActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.stack_cards_new_note_mode) {
            if(!codeMode) {
                codeMode = true;
                stackViewAdapter = new NoteStackViewAdapter(noteCards, R.layout.item_stack_note, StackCardsActivity.this, codeMode);

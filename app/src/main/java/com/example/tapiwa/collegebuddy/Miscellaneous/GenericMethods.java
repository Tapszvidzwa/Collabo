            ...
            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                ...
                try {
                   ...
                   StorageReference pdfStorage = FirebaseStorage
                    ...
                    pdfStorage.child(MainFrontPageActivity.user).putFile(contentUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
     ...
     */int nameIndex = returnCursor.getColumnIndex(OpenableColumns.DISPLAY_NAME);
       ...
       final String filename = returnCursor.getString(nameIndex);
        ...
        final  String trimmedFileName = builder.toString();
                    ...
                    pdfStorage.child(MainFrontPageActivity.user).putFile(uri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
